...
# Add all subreddits as nodes (even with no crossposts)
...
# Post count as node size signal
...
for name, data in [("network_subreddit",sub_net),("network_author",auth_net),("network_source",src_net)]:
