...
EVENTS = [
    ...
    {"date":"2025-01-20","event":"Trump Inauguration Day","type":"inauguration"},
    {"date":"2025-01-20","event":"Trump signs executive orders on border and immigration","type":"policy"},
