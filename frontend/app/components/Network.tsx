...
export default function Network() {
  ...
  // Simple force-free layout: position by post_count rank in a circle
    ...
    <div>
      ...
      <div className="flex gap-6">
        ...
        <div style={{ width: 200 }}>
          ...
          {selected && (
            <div className="p-3 rounded-lg" style={{ background: '#1a1f2e', border: '1px solid #4f46e5' }}>
              ...
              <p className="text-xs" style={{ color: '#a0aec0' }}>Score: {selected.total_score}</p>
            </div>
          )}
        </div>
      </div>
